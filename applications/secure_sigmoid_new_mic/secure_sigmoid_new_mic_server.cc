...
#include "applications/secure_sigmoid_new_mic/secure_sigmoid_new_mic_rpc_impl.h"
...
int RunServer() {
  ...
  std::unique_ptr<applications::SecureSigmoidNewMic> secure_sigmoid = 
		applications::SecureSigmoidNewMic::Create(
  ...
  SecureSigmoidNewMicRpcImpl service(std::move(sigmoid_input_share),
