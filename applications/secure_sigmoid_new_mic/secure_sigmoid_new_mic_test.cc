...
namespace private_join_and_compute {
    namespace applications {
        namespace {
            ...
            const size_t kLogGroupSize = 62;
            const uint64_t kIntervalCount = 10;

            // Fixing the input batch size.
//           const uint64_t kNumInputs = 10;//65536;//401;//16;
            ...
            // The first param in kSampleLargeExpParams represents
            ...
            const SecureSigmoidNewMicParameters sigmoid_params{
                    kLogGroupSize,
            ...
            class SecureSigmoidNewMicTest : public Test {
            protected:
...
TEST_F(SecureSigmoidNewMicTest, EndToEndSucceeds) {


    ASSERT_OK_AND_ASSIGN(std::unique_ptr<SecureSigmoidNewMic> secure_sigmoid,
                                 SecureSigmoidNewMic::Create(kNumInputs, sigmoid_params));


    std::pair<SigmoidPrecomputedValueNewMic, SigmoidPrecomputedValueNewMic> preCompRes;
    ...
    std::pair<RoundOneSigmoidNewMicState, RoundOneSigmoidNewMicMessage> round_one_res_party0;
    std::pair<RoundOneSigmoidNewMicState, RoundOneSigmoidNewMicMessage> round_one_res_party1;
    ...
    ASSERT_OK_AND_ASSIGN(
        ...
        std::pair<RoundTwoSigmoidNewMicState, RoundTwoSigmoidNewMicMessage> round_two_res_party0,
        ...
        std::pair<RoundThreeSigmoidNewMicState, RoundThreeSigmoidNewMicMessage> round_three_res_party0,
        ...
        std::pair<RoundThreePointFiveSigmoidNewMicState,
         RoundThreePointFiveSigmoidNewMicMessage> round_three_point_five_res_party0,
        ...
        std::pair<RoundFourSigmoidNewMicState, RoundFourSigmoidNewMicMessage> round_four_res_party0,
        ...
        std::pair<RoundFiveSigmoidNewMicState, RoundFiveSigmoidNewMicMessage> round_five_res_party0,
        ...
        for (int i = 0; i < kNumInputs; i++) {
          ...
          //std::cout << "Input " << sigmoid_inputs[i] << std::endl;

          //std::cout << "Calculated : " << res_i.ExportToDouble() << std::endl;
          // std::cout << res_i.ExportToDouble() << std::endl;

          //std::cout << "Actual : " << actual_sigmoid_output << std::endl;

          //std::cout << std::endl;

          EXPECT_NEAR(res_i.ExportToDouble(), actual_sigmoid_output, 0.001);
        }
    }
